...
- **Shop:** Spend your earned points to generate a random item to store in your collection. Points are accumulated based on your score from each round of games.
